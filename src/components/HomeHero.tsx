const HomeHero = () => {
  return (
    <div className="bg-[#ffffff] w-screen h-screen text-white flex justify-center items-center pt-12 md:pt-36">
      <div className="px-4 max-w-[70rem] flex flex-col mx-auto gap-12">
        <div className="mt-100">
          <div className="max-w-6xl text-center mx-auto text-2xl font-semibold md:text-4xl lg:text-6xl">
            <h1
              id="Headline"
              className="text-[#fc921b] text-4xl lg:text-6xl underline underline-offset-12 mt-12"
            ...
            <h1
              id="Headline"
              className="text-[#004AAD] mt-8" // Adjusted margin-top here
              style={{ transformStyle: "preserve-3d" }}
            >
